...
class SetupDiceRoller:
    ...
    def roll_setup_category(self, category: SetupCategory) -> int:
        """
    ...
    def roll_all_categories(self) -> Dict[SetupCategory, int]:
        """
        ...
        """
        return {
            category: self.roll_setup_category(category)
    ...
    def roll_for_driver(self, driver: str) -> Dict[SetupCategory, int]:
        ...
        """
        return self.roll_all_categories()
...
class SetupEffectCalculator:
    ...
    @staticmethod
    def normalize_to_r_delta(total_effect: float, min_delta: float = -0.5, max_delta: float = 0.5) -> float:
        """
...
class SetupTuningManager:
    ...
    def generate_setup_report(
        ...
        sorted_setups = sorted(
            setups.items(),
            key=lambda x: x[1].r_rating_delta,
            reverse=True
        )
