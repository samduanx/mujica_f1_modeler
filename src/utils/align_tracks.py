...
def get_fastf1_events():
    ...
    for year in years_to_check:
        try:
            # 启用缓存，避免重复下载
            cache_dir = os.path.join(os.path.dirname(__file__), "..", "outputs", "f1_cache")
...
def align_track_names(excel_file_path):
    ...
    output_csv = "outputs/tables/aligned_track_characteristics.csv"
...
if __name__ == "__main__":
    excel_file = "outputs/tables/track_characteristics.xlsx"
